...
var HTMLonlineClasses = '<div class="onlineEducation-entry"><h3 class="onlineClasses">Online Classes</h3></div>';
...
The Internationalize Names challenge found in the lesson Flow Control from JavaScript Basics
 requires you to create a function that will need this helper code to run. Don't delete! It hooks
  up your code to the button you'll be appending.
*/
